...
description: Anti-slop frontend design skill for landing pages, portfolios, and redesigns. Use when building, critiquing, or redesigning UI, web pages, or visual interfaces — infers the right design direction and ships interfaces that don't look templated.
---
