...
export function VerifiedIdentityPanel() {
      ...
      <Card className="border-[#10B981]/30 bg-[#10B981]/10">
        <CardContent className="flex items-center justify-between gap-3 p-3">
          <div className="min-w-0">
            <div className="flex items-center gap-2 text-sm font-semibold text-[#D1FAE5]">
              <ShieldCheck className="h-4 w-4 shrink-0" />
              <span className="truncate">{verifiedUser.display_name}</span>
            </div>
            <p className="truncate text-xs text-[#D1FAE5]/70">Verified producer identity</p>
          </div>
          <Button
            type="button"
            variant="outline"
            ...
            className="shrink-0 border-[#10B981]/40"
          >
  ...
  return (
    <Card className="border-[#7C3AED]/30 bg-[#0F0F23]/60">
      <CardContent className="space-y-3 p-3">
        <div className="flex items-start gap-2">
          <BadgeCheck className="mt-0.5 h-4 w-4 shrink-0 text-[#A78BFA]" />
          <div className="min-w-0">
            <p className="text-sm font-semibold text-[#E2E8F0]">Verify your producer name</p>
            <p className="text-xs text-[#E2E8F0]/60">Required for protected names and leaderboard credit.</p>
          </div>
        </div>
        ...
        {message && <p className="text-xs text-[#E2E8F0]/70">{message}</p>}
        ...
        <Button
          ...
          className="w-full border-[#7C3AED]/40"
        >
