    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Button
          ...
          variant="outline"
          className="h-14 text-sm font-bold border-2 border-muted-foreground/20 hover:border-primary/50 hover:bg-primary/5 transition-all duration-200"
        >
      ...
      <div className="pt-3 border-t border-muted-foreground/10">
        {discordAccountStatus?.is_linked && discordAccountStatus.discord_username ? (
          ...
          <Button
            ...
            variant="ghost"
            size="sm"
            className="w-full text-xs text-muted-foreground hover:text-foreground hover:bg-muted gap-2"
          >
