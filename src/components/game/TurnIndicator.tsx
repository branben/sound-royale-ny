    ...
    >
      ...
      <div className="flex-1">
        <div className="flex items-center gap-2">
          <h3 className="font-semibold text-foreground">Round prompt</h3>
        </div>
        ...
        <div className="flex items-center gap-2 mt-1">
          {isActive ? (
            <div className="flex items-center gap-1 text-green-500">
              ...
              <span className="text-sm font-medium">{activeGenre || 'Unknown'}</span>
            </div>
          ) : (
            <span className="text-sm text-muted-foreground">Waiting for turn...</span>
          )}
        </div>
      </div>
