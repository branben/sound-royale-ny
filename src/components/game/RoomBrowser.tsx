...
export const RoomBrowser: React.FC<RoomBrowserProps> = ({ isOpen, onClose, onRoomJoined }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl bg-[#0F0F23] border-[#7C3AED]/30 text-white max-h-[80dvh] overflow-y-auto">
        <DialogHeader>
        ...
        <div className="space-y-4 mt-4">
          {isLoading ? (
            ...
            <div className="text-center py-8">
              <Sparkles className="h-12 w-12 mx-auto mb-4 text-[#7C3AED]/50" />
            ...
            <div className="space-y-3">
              {rooms.map((room) => (
                <Card key={room.code} className="bg-[#111126] border-[#7C3AED]/30 hover:border-[#7C3AED]/60 transition-colors">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        ...
                        className="bg-gradient-to-r from-[#7C3AED] to-[#F43F5E] hover:shadow-[0_6px_20px_rgba(124,58,237,0.5)]"
                      >
          ...
          <div className="pt-4 border-t border-[#7C3AED]/20">
            <Button onClick={loadRooms} variant="outline" className="w-full border-[#7C3AED]/30 hover:bg-[#7C3AED]/10">
              Refresh Rooms
            </Button>
          </div>
        </div>
