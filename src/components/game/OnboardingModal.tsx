...
export const OnboardingModal: React.FC<OnboardingModalProps> = ({ isOpen, onClose }) => {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl bg-[#0F0F23] border-[#7C3AED]/30 text-white max-h-[90dvh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold font-['Righteous'] text-transparent bg-clip-text bg-gradient-to-r from-[#7C3AED] to-[#F43F5E]">
        ...
        <div className="space-y-6 mt-4">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-4 pl-13">
              <div className="rounded-lg border border-[#7C3AED]/30 bg-[#111126] p-4">
                <h4 className="font-semibold text-[#7C3AED] mb-2">🎵 Producer</h4>
                <p className="text-sm text-gray-300">
                  Upload your beats for each genre tile. First to complete a line wins!
                </p>
              </div>
              <div className="rounded-lg border border-[#F43F5E]/30 bg-[#111126] p-4">
                <h4 className="font-semibold text-[#F43F5E] mb-2">👀 Spectator</h4>
                <p className="text-sm text-gray-300">
          ...
          {/* Quick Tips */}
          <div className="rounded-lg border border-[#7C3AED]/20 bg-[#111126] p-4">
            <h4 className="font-semibold text-[#7C3AED] mb-3">💡 Quick Tips</h4>
          ...
          <div className="flex gap-3 pt-4">
            <Button
              onClick={onClose}
              className="flex-1 bg-gradient-to-r from-[#7C3AED] to-[#F43F5E] hover:shadow-[0_6px_20px_rgba(124,58,237,0.5)]"
            >
