      ...
      <div className="text-center">
        {status === 'loading' && (
          <div className="space-y-4">
            ...
            <p className="text-[#E2E8F0] text-lg">Linking your Discord account...</p>
          </div>
        )}
        ...
        {status === 'success' && (
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-[#E2E8F0]">Your Discord account has been linked.</p>
            </div>
          </div>
        )}
        ...
        {status === 'error' && (
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-[#E2E8F0]">Failed to link your Discord account.</p>
            </div>
          </div>
        )}
      </div>
