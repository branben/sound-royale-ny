...
// .wrangler/tmp/pages-lvkJOf/functionsWorker-0.6208318972196897.mjs
...
async function onRequest(context) {
  ...
  const skip = /* @__PURE__ */ new Set(['host', 'content-length']);
...
// .wrangler/tmp/bundle-JexyYs/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-JexyYs/middleware-loader.entry.ts
...
function wrapExportedHandler2(worker) {
  if (
    __INTERNAL_WRANGLER_MIDDLEWARE__2 === void 0 ||
    __INTERNAL_WRANGLER_MIDDLEWARE__2.length === 0
  ) {
    return worker;
  }
...
//# sourceMappingURL=functionsWorker-0.6208318972196897.js.map
