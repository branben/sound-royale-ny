...
def seed():
    ...
    players_data = [
        {"name": "VerifiedProducer", "elo_rating": 1340, "elo_wins": 8, "elo_losses": 2},
        {"name": "BeatMaster99", "elo_rating": 1280, "elo_wins": 6, "elo_losses": 3},
        {"name": "SampleKing", "elo_rating": 1240, "elo_wins": 5, "elo_losses": 4},
